...
TEXT = {
    "en": {
        ...
        "sector_list": [
            "IT & Technology", "Healthcare & Medical", "Education & E-Learning", "Banking & Finance", 
            "Marketing & Sales", "E-Commerce & Retail", "Content & Media", "Customer Service", 
            "Beauty & Wellness", "Caregiving & Homecare", "Creative Arts & Design", "Administration & HR", 
            "Agriculture & Dairy", "Hospitality & Tourism", "Manufacturing & Logistics", "Legal & Compliance", 
            "Gig Economy & Freelance", "Real Estate & Property", "Social Work & NGO", "Government Services",
            "Data & Analytics", "Science & Research", "Telecommunications", "Energy & Environment", "General"
        ],
        "domain_list": [
            "Software Engineering", "Web Development", "Mobile App Dev", "Cloud & DevOps", "Cybersecurity", "Data Science", "AI & Machine Learning", "QA Testing", "IT Support", "Systems Administration", "Database Management",
            "Nursing", "Medical Doctors", "Allied Health", "Mental Health", "Pharma Sales", "Medical Coding", "Health Administration", "Physiotherapy", "Lab Technician",
            "School Teaching", "Higher Education", "EdTech", "Tutoring", "Corporate Training", "Special Education", "Curriculum Development", "Language Training",
            "Accounting", "Financial Analysis", "Banking Operations", "Insurance", "Investment", "Tax Consulting", "Wealth Management", "Risk Management", "Fintech", "Bookkeeping",
            "Sales", "Marketing", "Digital Marketing", "SEO & SEM", "Social Media Marketing", "PR & Communications", "Brand Management", "Market Research", "Advertising",
            "Ecommerce", "Retail", "Digital Store Mgmt", "Cataloging", "Inventory Mgmt", "Supply Chain", "Merchandising", "Dropshipping",
            "Content Writing", "Copywriting", "Journalism", "Editing", "Video Production", "Graphic Design", "Animation & VFX", "Blogging",
            "Customer Support", "BPO & Call Center", "Technical Support", "CRM Management", "Virtual Assistant", "Data Entry", "Order Processing",
            "Beauty Wellness", "Makeup & Styling", "Skincare", "Yoga & Meditation", "Personal Training", "Nutrition & Dietetics", "Spa & Therapy",
            "Childcare", "Elderly Care", "Babysitting", "Caregiving", "Special Needs Care", "Home Management", "Nursing at Home",
            "Fashion Design", "Interior Design", "Handicrafts", "Jewellery Design", "UI/UX Design", "Photography", "Illustration", "Tailoring",
            "Administration", "HR", "Recruitment", "Payroll & Benefits", "Office Management", "Executive Assistant", "Training & Development", "Legal Secretary",
            "Agriculture", "Dairy Animal", "Poultry Farming", "Organic Farming", "Agri-Business", "Agri-Tech", "Horticulture", "Veterinary Services",
            "Hotel Management", "Food Service", "Travel Tourism", "Event Management", "Front Office", "Tour Guiding", "Flight Attendant",
            "Manufacturing", "Quality Control", "Production Planning", "Warehouse Mgmt", "Supply Chain Co-ordination", "Safety Management",
            "Legal", "Paralegal", "Corporate Law", "Litigation", "Intellectual Property", "Compliance", "Notary Services",
            "Freelancing", "Micro-tasks", "Delivery Logistics", "Ride Sharing", "Home Services",
            "Real Estate", "Property Management", "Real Estate Sales", "Construction", "Architecture",
            "Social Work", "NGO Mgmt", "Fundraising", "Community Development", "Counseling",
            "Government", "Public Safety", "Municipal Services", "Policy Research", "Infrastructure",
            "Data Analytics", "Big Data", "Business Intelligence", "Statistical Analysis",
            "Research & Development", "Biotechnology", "Environmental Science",
            "Network Engineering", "Telecom Operations", "Broadband Services",
            "Renewable Energy", "Waste Management", "Sustainability Consulting",
            "General"
        ],
        ...
        "sector_domain_mapping": {
            "IT & Technology": ["Software Engineering", "Web Development", "Mobile App Dev", "Cloud & DevOps", "Cybersecurity", "Data Science", "AI & Machine Learning", "QA Testing", "IT Support", "Systems Administration", "Database Management"],
            "Healthcare & Medical": ["Nursing", "Medical Doctors", "Allied Health", "Mental Health", "Pharma Sales", "Medical Coding", "Health Administration", "Physiotherapy", "Lab Technician"],
            "Education & E-Learning": ["School Teaching", "Higher Education", "EdTech", "Tutoring", "Corporate Training", "Special Education", "Curriculum Development", "Language Training"],
            "Banking & Finance": ["Accounting", "Financial Analysis", "Banking Operations", "Insurance", "Investment", "Tax Consulting", "Wealth Management", "Risk Management", "Fintech", "Bookkeeping"],
            "Marketing & Sales": ["Sales", "Marketing", "Digital Marketing", "SEO & SEM", "Social Media Marketing", "PR & Communications", "Brand Management", "Market Research", "Advertising"],
            "E-Commerce & Retail": ["Ecommerce", "Retail", "Digital Store Mgmt", "Cataloging", "Inventory Mgmt", "Supply Chain", "Merchandising", "Dropshipping"],
            "Content & Media": ["Content Writing", "Copywriting", "Journalism", "Editing", "Video Production", "Graphic Design", "Animation & VFX", "Blogging"],
            "Customer Service": ["Customer Support", "BPO & Call Center", "Technical Support", "CRM Management", "Virtual Assistant", "Data Entry", "Order Processing"],
            "Beauty & Wellness": ["Beauty Wellness", "Makeup & Styling", "Skincare", "Yoga & Meditation", "Personal Training", "Nutrition & Dietetics", "Spa & Therapy"],
            "Caregiving & Homecare": ["Childcare", "Elderly Care", "Babysitting", "Caregiving", "Special Needs Care", "Home Management", "Nursing at Home"],
            "Creative Arts & Design": ["Fashion Design", "Interior Design", "Handicrafts", "Jewellery Design", "UI/UX Design", "Photography", "Illustration", "Tailoring"],
            "Administration & HR": ["Administration", "HR", "Recruitment", "Payroll & Benefits", "Office Management", "Executive Assistant", "Training & Development", "Legal Secretary"],
            "Agriculture & Dairy": ["Agriculture", "Dairy Animal", "Poultry Farming", "Organic Farming", "Agri-Business", "Agri-Tech", "Horticulture", "Veterinary Services"],
            "Hospitality & Tourism": ["Hotel Management", "Food Service", "Travel Tourism", "Event Management", "Front Office", "Tour Guiding", "Flight Attendant"],
            "Manufacturing & Logistics": ["Manufacturing", "Quality Control", "Production Planning", "Warehouse Mgmt", "Supply Chain Co-ordination", "Safety Management"],
            "Legal & Compliance": ["Legal", "Paralegal", "Corporate Law", "Litigation", "Intellectual Property", "Compliance", "Notary Services"],
            "Gig Economy & Freelance": ["Freelancing", "Micro-tasks", "Delivery Logistics", "Ride Sharing", "Home Services"],
            "Real Estate & Property": ["Real Estate", "Property Management", "Real Estate Sales", "Construction", "Architecture"],
            "Social Work & NGO": ["Social Work", "NGO Mgmt", "Fundraising", "Community Development", "Counseling"],
            "Government Services": ["Government", "Public Safety", "Municipal Services", "Policy Research", "Infrastructure"],
            "Data & Analytics": ["Data Analytics", "Big Data", "Business Intelligence", "Statistical Analysis"],
            "Science & Research": ["Research & Development", "Biotechnology", "Environmental Science"],
            "Telecommunications": ["Network Engineering", "Telecom Operations", "Broadband Services"],
            "Energy & Environment": ["Renewable Energy", "Waste Management", "Sustainability Consulting"],
            "General": ["General"]
        },
    ...
    "hi": {
        ...
        "sector_list": [
            "आईटी और टेक्नोलॉजी", "स्वास्थ्य और चिकित्सा", "शिक्षा और ई-लर्निंग", "बैंकिंग और वित्त", 
            "विपणन और बिक्री", "ई-कॉमर्स और रिटेल", "कंटेंट और मीडिया", "ग्राहक सेवा", 
            "सौंदर्य और कल्याण", "देखभाल और होमकेयर", "रचनात्मक कला और डिज़ाइन", "प्रशासन और एचआर", 
            "कृषि और डेयरी", "आतिथ्य और पर्यटन", "विनिर्माण और रसद", "कानूनी और अनुपालन", 
            "गिग इकॉनमी और फ्रीलांस", "रियल एस्टेट और प्रॉपर्टी", "सामाजिक कार्य और एनजीओ", "सरकारी सेवाएं",
            "डेटा और एनालिटिक्स", "विज्ञान और अनुसंधान", "दूरसंचार", "ऊर्जा और पर्यावरण", "सामान्य"
        ],
        "domain_list": [
            "सॉफ्टवेयर इंजीनियरिंग", "वेब डेवलपमेंट", "मोबाइल ऐप देव", "क्लाउड और DevOps", "साइबरसिक्योरिटी", "डेटा साइंस", "एआई और मशीन लर्निंग", "क्यूए टेस्टिंग", "आईटी सपोर्ट", "सिस्टम एडमिनिस्ट्रेशन", "डेटाबेस मैनेजमेंट",
            "नर्सिंग", "चिकित्सक", "सम्बद्ध स्वास्थ्य", "मानसिक स्वास्थ्य", "फार्मा सेल्स", "मेडिकल कोडिंग", "स्वास्थ्य प्रशासन", "फिजियोथेरेपी", "लैब तकनीशियन",
            "स्कूल टीचिंग", "उच्च शिक्षा", "एडटेक", "ट्यूटरिंग", "कॉर्पोरेट ट्रेनिंग", "विशेष शिक्षा", "पाठ्यक्रम विकास", "भाषा प्रशिक्षण",
            "अकाउंटिंग", "वित्तीय विश्लेषण", "बैंकिंग ऑपरेशंस", "बीमा", "निवेश", "टैक्स कंसल्टिंग", "वेल्थ मैनेजमेंट", "जोखिम प्रबंधन", "फिनटेक", "बुककीपिंग",
            "बिक्री", "मार्केटिंग", "डिजिटल मार्केटिंग", "एसईओ और एसईएम", "सोशल मीडिया मार्केटिंग", "पीआर और संचार", "ब्रांड मैनेजमेंट", "मार्केट रिसर्च", "विज्ञापन",
            "ई-कॉमर्स", "रिटेल", "डिजिटल स्टोर मैनेजमेंट", "कैटलॉगिंग", "इन्वेंट्री मैनेजमेंट", "सप्लाई चेन", "मर्चेंडाइजिंग", "ड्रॉपशिपिंग",
            "कंटेंट राइटिंग", "कॉपीराइटिंग", "पत्रकारिता", "संपादन", "वीडियो प्रोडक्शन", "ग्राफिक डिज़ाइन", "एनिमेशन और वीएफएक्स", "ब्लॉगिंग",
            "ग्राहक सहायता", "बीपीओ और कॉल सेंटर", "तकनीकी सहायता", "सीआरएम मैनेजमेंट", "वर्चुअल असिस्टेंट", "डेटा एंट्री", "ऑर्डर प्रोसेसिंग",
            "सौंदर्य कल्याण", "मेकअप और स्टाइलिंग", "त्वचा की देखभाल", "योग और ध्यान", "पर्सनल ट्रेनिंग", "पोषण और आहार", "स्पा और थेरेपी",
            "बाल देखभाल", "वृद्ध देखभाल", "बेबीसिटिंग", "देखभाल", "विशेष आवश्यकता देखभाल", "होम मैनेजमेंट", "घर पर नर्सिंग",
            "फैशन डिज़ाइन", "इंटीरियर डिज़ाइन", "हस्तकला", "आभूषण डिज़ाइन", "UI/UX डिज़ाइन", "फोटोग्राफी", "इल्लेसट्रेशन", "सिलाई / टेलरिंग",
            "प्रशासन", "एचआर", "भर्ती", "पेरोल और लाभ", "कार्यालय प्रबंधन", "कार्यकारी सहायक", "प्रशिक्षण और विकास", "कानूनी सचिव",
            "कृषि", "डेयरी पशु", "पोल्ट्री फार्मिंग", "जैविक खेती", "कृषि-व्यवसाय", "कृषि-तकनीक", "बागवानी", "पशु चिकित्सा सेवाएं",
            "होटल मैनेजमेंट", "खाद्य सेवा", "ट्रैवल टूरिज्म", "इवेंट मैनेजमेंट", "फ्रंट ऑफिस", "टूर गाइडिंग", "फ्लाइट अटेंडेंट",
            "विनिर्माण", "क्वालिटी कंट्रोल", "उत्पादन योजना", "वेयरहाउस मैनेजमेंट", "सप्लाई चेन समन्वय", "सुरक्षा प्रबंधन",
            "कानूनी", "पैरालीगल", "कॉर्पोरेट कानून", "मुकदमा", "बौद्धिक संपदा", "अनुपालन", "नोटरी सेवाएं",
            "फ्रीलांसिंग", "माइक्रो-टास्क", "डिलीवरी लॉजिस्टिक्स", "राइड शेयरिंग", "होम सर्विसेज",
            "रियल एस्टेट", "प्रॉपर्टी मैनेजमेंट", "रियल एस्टेट बिक्री", "निर्माण", "वास्तुकला",
            "सामाजिक कार्य", "एनजीओ मैनेजमेंट", "फंड जुटाना", "सामुदायिक विकास", "परामर्श",
            "सरकारी", "सार्वजनिक सुरक्षा", "नगरपालिका सेवाएं", "नीति अनुसंधान", "इन्फ्रास्ट्रक्चर",
            "डेटा एनालिटिक्स", "बिग डेटा", "बिजनेस इंटेलिजेंस", "सांख्यिकीय विश्लेषण",
            "आर एंड डी", "बायोटेक्नोलॉजी", "पर्यावरण विज्ञान",
            "नेटवर्क इंजीनियरिंग", "दूरसंचार संचालन", "ब्रॉडबैंड सेवाएं",
            "नवीकरणीय ऊर्जा", "अपशिष्ट प्रबंधन", "स्थिरता परामर्श",
            "सामान्य"
        ],
        ...
        "sector_domain_mapping": {
            "आईटी और टेक्नोलॉजी": ["सॉफ्टवेयर इंजीनियरिंग", "वेब डेवलपमेंट", "मोबाइल ऐप देव", "क्लाउड और DevOps", "साइबरसिक्योरिटी", "डेटा साइंस", "एआई और मशीन लर्निंग", "क्यूए टेस्टिंग", "आईटी सपोर्ट", "सिस्टम एडमिनिस्ट्रेशन", "डेटाबेस मैनेजमेंट"],
            "स्वास्थ्य और चिकित्सा": ["नर्सिंग", "चिकित्सक", "सम्बद्ध स्वास्थ्य", "मानसिक स्वास्थ्य", "फार्मा सेल्स", "मेडिकल कोडिंग", "स्वास्थ्य प्रशासन", "फिजियोथेरेपी", "लैब तकनीशियन"],
            "शिक्षा और ई-लर्निंग": ["स्कूल टीचिंग", "उच्च शिक्षा", "एडटेक", "ट्यूटरिंग", "कॉर्पोरेट ट्रेनिंग", "विशेष शिक्षा", "पाठ्यक्रम विकास", "भाषा प्रशिक्षण"],
            "बैंकिंग और वित्त": ["अकाउंटिंग", "वित्तीय विश्लेषण", "बैंकिंग ऑपरेशंस", "बीमा", "निवेश", "टैक्स कंसल्टिंग", "वेल्थ मैनेजमेंट", "जोखिम प्रबंधन", "फिनटेक", "बुककीपिंग"],
            "विपणन और बिक्री": ["बिक्री", "मार्केटिंग", "डिजिटल मार्केटिंग", "एसईओ और एसईएम", "सोशल मीडिया मार्केटिंग", "पीआर और संचार", "ब्रांड मैनेजमेंट", "मार्केट रिसर्च", "विज्ञापन"],
            "ई-कॉमर्स और रिटेल": ["ई-कॉमर्स", "रिटेल", "डिजिटल स्टोर मैनेजमेंट", "कैटलॉगिंग", "इन्वेंट्री मैनेजमेंट", "सप्लाई चेन", "मर्चेंडाइजिंग", "ड्रॉपशिपिंग"],
            "कंटेंट और मीडिया": ["कंटेंट राइटिंग", "कॉपीराइटिंग", "पत्रकारिता", "संपादन", "वीडियो प्रोडक्शन", "ग्राफिक डिज़ाइन", "एनिमेशन और वीएफएक्स", "ब्लॉगिंग"],
            "ग्राहक सेवा": ["ग्राहक सहायता", "बीपीओ और कॉल सेंटर", "तकनीकी सहायता", "सीआरएम मैनेजमेंट", "वर्चुअल असिस्टेंट", "डेटा एंट्री", "ऑर्डर प्रोसेसिंग"],
            "सौंदर्य और कल्याण": ["सौंदर्य कल्याण", "मेकअप और स्टाइलिंग", "त्वचा की देखभाल", "योग और ध्यान", "पर्सनल ट्रेनिंग", "पोषण और आहार", "स्पा और थेरेपी"],
            "देखभाल और होमकेयर": ["बाल देखभाल", "वृद्ध देखभाल", "बेबीसिटिंग", "देखभाल", "विशेष आवश्यकता देखभाल", "होम मैनेजमेंट", "घर पर नर्सिंग"],
            "रचनात्मक कला और डिज़ाइन": ["फैशन डिज़ाइन", "इंटीरियर डिज़ाइन", "हस्तकला", "आभूषण डिज़ाइन", "UI/UX डिज़ाइन", "फोटोग्राफी", "इल्लेसट्रेशन", "सिलाई / टेलरिंग"],
            "प्रशासन और एचआर": ["प्रशासन", "एचआर", "भर्ती", "पेरोल और लाभ", "कार्यालय प्रबंधन", "कार्यकारी सहायक", "प्रशिक्षण और विकास", "कानूनी सचिव"],
            "कृषि और डेयरी": ["कृषि", "डेयरी पशु", "पोल्ट्री फार्मिंग", "जैविक खेती", "कृषि-व्यवसाय", "कृषि-तकनीक", "बागवानी", "पशु चिकित्सा सेवाएं"],
            "आतिथ्य और पर्यटन": ["होटल मैनेजमेंट", "खाद्य सेवा", "ट्रैवल टूरिज्म", "इवेंट मैनेजमेंट", "फ्रंट ऑफिस", "टूर गाइडिंग", "फ्लाइट अटेंडेंट"],
            "विनिर्माण और रसद": ["विनिर्माण", "क्वालिटी कंट्रोल", "उत्पादन योजना", "वेयरहाउस मैनेजमेंट", "सप्लाई चेन समन्वय", "सुरक्षा प्रबंधन"],
            "कानूनी और अनुपालन": ["कानूनी", "पैरालीगल", "कॉर्पोरेट कानून", "मुकदमा", "बौद्धिक संपदा", "अनुपालन", "नोटरी सेवाएं"],
            "गिग इकॉनमी और फ्रीलांस": ["फ्रीलांसिंग", "माइक्रो-टास्क", "डिलीवरी लॉजिस्टिक्स", "राइड शेयरिंग", "होम सर्विसेज"],
            "रियल एस्टेट और प्रॉपर्टी": ["रियल एस्टेट", "प्रॉपर्टी मैनेजमेंट", "रियल एस्टेट बिक्री", "निर्माण", "वास्तुकला"],
